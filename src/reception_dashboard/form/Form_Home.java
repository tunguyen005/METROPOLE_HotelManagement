package reception_dashboard.form;

import reception_dashboard.component.Card;
import reception_dashboard.dialog.Message;
import reception_dashboard.model.ModelCard;
import reception_dashboard.model.ModelPerson;
import reception_dashboard.swing.icon.GoogleMaterialDesignIcons;
import reception_dashboard.swing.icon.IconFontSwing;
import reception_dashboard.swing.noticeboard.ModelNoticeBoard;
import reception_dashboard.swing.noticeboard.NoticeBoard;
import reception_dashboard.swing.table.EventAction;
import reception_dashboard.swing.table.Table;
import screen_utils.ScrReception;
...
public class Form_Home extends javax.swing.JPanel {
    ...
    private void initTableData() {
        EventAction eventAction = new EventAction() {
            ...
            public void delete(ModelPerson person) {
                if (showMessage("Delete Student : " + person.getName())) {
            ...
            public void update(ModelPerson person) {
                if (showMessage("Update Student : " + person.getName())) {
                    System.out.println("User click OK");
                } else {
                    System.out.println("User click Cancel");
                }
        ...
        table1.addRow(new ModelPerson(new ImageIcon(getClass().getResource("/reception_dashboard/icon/profile.jpg")), "Jonh", "Male", "Java", 300).toRowTable(eventAction));
        table1.addRow(new ModelPerson(new ImageIcon(getClass().getResource("/reception_dashboard/icon/profile1.jpg")), "Dara", "Male", "C++", 300).toRowTable(eventAction));
        table1.addRow(new ModelPerson(new ImageIcon(getClass().getResource("/reception_dashboard/icon/profile2.jpg")), "Bora", "Male", "C#", 300).toRowTable(eventAction));
        table1.addRow(new ModelPerson(new ImageIcon(getClass().getResource("/reception_dashboard/icon/profile2.jpg")), "Bora", "Male", "C#", 300).toRowTable(eventAction));
        table1.addRow(new ModelPerson(new ImageIcon(getClass().getResource("/reception_dashboard/icon/profile2.jpg")), "Bora", "Male", "C#", 300).toRowTable(eventAction));
        table1.addRow(new ModelPerson(new ImageIcon(getClass().getResource("/reception_dashboard/icon/profile2.jpg")), "Bora", "Male", "C#", 300).toRowTable(eventAction));
        table1.addRow(new ModelPerson(new ImageIcon(getClass().getResource("reception_dashboard/icon/profile2.jpg")), "Bora", "Male", "C#", 300).toRowTable(eventAction));
    ...
    private boolean showMessage(String message) {
        Message obj = new Message(ScrReception.getFrames()[0], true);
