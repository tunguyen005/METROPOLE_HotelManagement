...
import reception_dashboard.swing.Button;
...
public class Action extends javax.swing.JPanel {
    ...
    public Action(ModelAction data) {
        ...
        cmdEdit.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                data.getEvent().update(data.getPerson());
            }
        });
        cmdDelete.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent ae) {
                data.getEvent().delete(data.getPerson());
            }
        });
    }
    ...
    private void initComponents() {
        ...
        cmdEdit.setIcon(new javax.swing.ImageIcon(getClass().getResource("/reception_dashboard/icon/edit.png"))); // NOI18N

        cmdDelete.setIcon(new javax.swing.ImageIcon(getClass().getResource("/reception_dashboard/icon/delete.png"))); // NOI18N
